...
public class Exercise_5 {
	...
	public static void main(String[] args) throws ParseException {
		...
		while(ctr1==true) {
			...
			System.out.println("**       1. Thực hiện tạo account               **");
			System.out.println("**       2. Thực hiện tạo department            **");
			System.out.println("**       3. Thực hiện thêm account vào group    **");
			System.out.println("**       0. Thoát                               **");
			System.out.println("**************************************************");
			System.out.println("**   Mời bạn nhập vào chức năng muốn sử dụng: ");
			...
			if(scanner.hasNextInt()) {
				...
				case 1:
					...
					createAccount();
					System.out.println("Bạn có muốn tiếp tục chương trình: ( 1: Có, Any_key: Không ): ");
					int exit = scanner.nextInt();
					if(exit != 1) {
						System.out.println("Chương trình đã thoát. Xin cảm ơn!!");
						return;
					}
					break;
				case 2:
		...
		while(ctr3==true) {
			...
			if(scanner.hasNextInt()) {
				...
				case 3:
					...
					break;
				case 4:
					createGroupAccountRandom();
					System.out.println("Bạn có muốn tiếp tục chương trình: ( 1: Có, Any_key: Không ): ");
					int exit3 = scanner.nextInt();
					if(exit3 != 1) {
						System.out.println("Chương trình đã thoát. Xin cảm ơn!!");
						return;
					}
	...
	static void createGroupAccountRandom() {
		Scanner scanner = new Scanner(System.in);
		...
		System.out.println("1 group random bạn được thêm tự động là: " + groups[groupRandom].name);
